...
public class GameOver : MonoBehaviour
{
	...
	private void OnTap(InputAction.CallbackContext context)
	{
		if (context.ReadValueAsButton()) {
			...
			//テキスト
			var GameOver_Text_cs = this.transform.Find("GameOver_Text").GetComponent<GameOver_Text>();
			StartCoroutine(GameOver_Text_cs.Move());
			StartCoroutine(GameOver_Text_cs.ChangeAlphaOut());
